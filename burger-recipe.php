...
<body>
                        ...
                        <div class="content">
                            ...
                            <div class="row">
                                ...
                                <ul class="mega-links">
                                    ...
                                    <li> <a href="burger-recipe.php">Breakfast</a>
                                    </li>
    ...
    <section class="page">
        <div class="recipe-page">
            <section class="recipe-hero">
                <img src="img/home/classburg.jpg" class="img recipe-hero-img" loading="lazy" alt="Food Image">
                <div class="recipe-info">
                    <h2>Classic Burger </h2>
                    <p id="p1"> Indulge in the irresistible allure of our
                        Classic Burger. Sink your teeth into a toasted bun,
                        topped with crisp lettuce, ripe tomatoes, onions, and
                        delectable bacon mayo.
    ...
    <section class="recipe-content">
        <div class="first-column">
            ...
            <div class="single-instruction">
                ...
                <p>Oil your grill or a cast-iron pan, and grill or sear the beef
                    patty as well as your burger bun around 54 degrees Celsius.
                    Cook them to your desired doneness.</p>
            </div>
            <!--STEP 2-->
            <div class="single-instruction">
                <header>
                ...
                <p>Once the beef patty is ready, add onion rings on top and let
                    it sit on the patty for a couple of minutes.</p>
            </div>
            <!--STEP 3-->
            <div class="single-instruction">
                <header>
                ...
                <p>Add the lettuce next and make sure it is already washed and
                    cleaned.</p>
            </div>
            <!--STEP 4-->
            <div class="single-instruction">
                ...
                <p>Spread the bacon mayonnaise generously on the base toasted
                    bun.</p>
            </div>
            <!--STEP 5-->
            <div class="single-instruction">
                ...
                <p>After making your burger, serve it on a plate with your
                    desired dips on the side. Enjoy your meal!</p>
            </div>
        </div>
    ...
    <section class="food-cards "> <?php include 'php/food-cards.php'; ?>
    </section>
    <section class="update-section "> <?php include 'php/update.php'; ?>
    </section>

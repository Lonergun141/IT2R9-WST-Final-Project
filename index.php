...
<body>
    ...
    <!--Category Section-------------------------------------->
    <div class="category-buttons " data-aos-anchor-placement="top-bottom"> <button
            class="category-button active" data-category="all">All</button> <button class="category-button"
            data-category="breakfast"> Breakfast </button> <button class="category-button"
            data-category="lunch">Lunch</button> <button class="category-button"
            data-category="dinner">Dinner</button> <button class="category-button"
            data-category="snacks">Snacks</button> </div>
    <!--Food card Section-------------------------------------->
    ...
    <section class="offer-section">
        ...
        <div class="offer-card"> <i class='bx bxs-book-content'></i>
            <h1>Best Recipes</h1>
        ...
        <div class="offer-card"> <i class='bx bx-universal-access'></i>
        ...
        <div class="offer-card"> <i class='bx bx-health'></i>
    ...
    <!--About-->
    <section class="about "> <?php include 'php/about-section.php'; ?> </section>
    <div class="title-pops">
        <h1><span>Popular</span>Recipes</h1>
        <h3>What our users love to learn</h3>
    </div>
    <section class="popular-recipe">
        <div class="pop-card"> <img src="img/home/classic-burg.jpg" loading="lazy" alt="Food Image">
            <div class="food-card-overlay">
                <h3 class="food-card-title">Regular Burger</h3>
                <p class="food-card-details">Burgers are a popular choice on food recipe websites due to their
                    versatility and wide appeal. With juicy beef patties, melted cheese, fresh vegetables, and
                    a variety of condiments, burgers offer a satisfying and customizable experience for any
                    burger lover.</p>
            </div>
        </div>
        <div class="pop-card"> <img src="img/home/pizza.jpg" loading="lazy" alt="Food Image">
            <div class="food-card-overlay">
                <h3 class="food-card-title">Pepperoni Pizza</h3>
                <p class="food-card-details">Pepperoni pizza is a beloved classic that has a special place in
                    the hearts of food enthusiasts. Its perfect combination of tangy tomato sauce, gooey
                    melted cheese, and savory pepperoni creates a mouthwatering experience that keeps people
                    coming back for more.</p>
            </div>
        </div>
        <div class="pop-card"> <img src="img/home/checken.jpg" loading="lazy" alt="Food Image">
            <div class="food-card-overlay">
                <h3 class="food-card-title">Korean Fried Chicken</h3>
                <p class="food-card-details">Korean fried chicken has taken the culinary world by storm with
                    its unique blend of crispy, flavorful coating and juicy, tender meat. The irresistible
                    combination of spicy, sweet, and savory flavors makes Korean fried chicken a favorite
                    among food enthusiasts, especially those who appreciate a little heat and a lot of
                    deliciousness.</p>
            </div>
        </div>
        <div class="pop-card"> <img src="img/home/cakepan.jpg" loading="lazy" alt="Food Image">
            <div class="food-card-overlay">
                <h3 class="food-card-title">Cake Pan</h3>
                <p class="food-card-details">Pancakes are a breakfast staple that has gained popularity on
                    food recipe websites for their simplicity and comfort. Fluffy and golden, these delightful
                    treats are often enjoyed with a drizzle of maple syrup and a pat of butter, making them a
                    go-to choice for a satisfying and indulgent morning meal.</p>
            </div>
        </div>
    </section>
